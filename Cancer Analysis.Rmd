...
p5 <- ggplot(dt, aes(x=menopaus)) +
    geom_bar(fill="powderblue") +
    ggtitle("Menopaus") + theme(axis.text.x = element_text(angle = 65, hjust = 1))
...
p8 <- ggplot(dt, aes(x=brstproc)) +
    geom_bar(fill="powderblue") +
    ggtitle("brstproc")+ theme(axis.text.x = element_text(angle = 65, hjust = 1))      

p9 <- ggplot(dt, aes(x=lastmamm)) +
    geom_bar(fill="powderblue") +
    ggtitle("BMI")+ theme(axis.text.x = element_text(angle = 65, hjust = 1))  
...
p11 <- ggplot(dt, aes(x=hrt)) +
    geom_bar(fill="powderblue") +
    ggtitle("hrt")+ theme(axis.text.x = element_text(angle = 65, hjust = 1))  

p12 <- ggplot(dt, aes(x=invasive)) +
    geom_bar(fill="powderblue") +
    ggtitle("Invasive")+ theme(axis.text.x = element_text(angle = 65, hjust = 1))  


p13 <- ggplot(dt, aes(x=cancer)) +
    geom_bar(fill="powderblue") +
    ggtitle("Cancer")+ theme(axis.text.x = element_text(angle = 65, hjust = 1)) 
